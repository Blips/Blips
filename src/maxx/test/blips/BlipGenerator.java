...
public class BlipGenerator {   
    ...
    static String[] noteNamesSharp = {"C", 
                                "C" + SHARP, "D",
                                "D" + SHARP, "E",
                                "F",
                                "F" + SHARP, "G",
    ...
    static final LinkedHashMap<String, int[]> scales = 
			...
			{
		        put("Ionian",          new int[] {2, 2, 1, 2, 2, 2, 1});
		        ...
		        put("Aeolian",         new int[] {2, 1, 2, 2, 1, 2, 2});
   ...
   static final int[] RAW_SOUNDS = {R.raw.pianoc4, R.raw.pianodb4, R.raw.pianod4, 
	   								...
	   								R.raw.trumpetc6, R.raw.trumpetdb6, R.raw.trumpetd6,
	   								R.raw.trumpeteb6,R.raw.trumpete6,R.raw.trumpetf6,
	   								R.raw.trumpetgb6,R.raw.trumpetg6, R.raw.trumpetab6, 
	   								R.raw.trumpeta6, R.raw.trumpetbb6, R.raw.trumpetb6, 
	   								...
	   								R.raw.trombonec5, R.raw.trombonedb5, R.raw.tromboned5, 
	   								R.raw.tromboneeb5, R.raw.trombonee5, R.raw.trombonef5, 
	   								R.raw.trombonegb5, R.raw.tromboneg5,R.raw.tromboneab5, 
	   								R.raw.trombonea5, R.raw.trombonebb5, R.raw.tromboneb5,
   ...
   public void startSequence (){
	         ...
	         handler.post (new Runnable () {
	            public void run () {
	            	...
	            	if (!(mainContext.resetting || loading || soundPool == null)) {
	            	   for (final int row : selections.get(playingIndex)) {
	            		   // Play sound and check result
	            	       
	            		   // Run play() on a separate thread so we can introduce swing functionality 
	            		   Thread t = new Thread(new Runnable() {
	            		         public void run()
	            		         {
	            		            if (playingIndex % 2 == 0) {
	            		                //delay playing by n ms
	            		                try {
                                            TimeUnit.MILLISECONDS.sleep(BlipsMain.ssliderValue);
	   ...
	   }, 0, BlipsMain.MILLI_DELAY-BlipsMain.tsliderValue);
   }
